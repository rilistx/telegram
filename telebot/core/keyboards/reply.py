...
loc_tel_poll_keyboard = ReplyKeyboardMarkup(keyboard=[
    [
        ...
        KeyboardButton(
            ...
            request_poll=KeyboardButtonPollType(type='regular'),  # -> KeyboardButtonPollType(type='regular')
        ),
    ]
...
def get_reply_keyboard():
    ...
    return keyboard_builder.as_markup(resize_keyboard=True, one_time_keyboard=False, input_field_placeholder='Выбери кнопку!')